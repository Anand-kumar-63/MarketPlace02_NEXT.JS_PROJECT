...
export default function   TransformSection() {
  ...
  return (
      ...
      <div className="flex flex-col lg:flex-row justify-between items-center w-full gap-10">
        ...
        {/* Right Image Section */}
        <div className="flex flex-col md:flex-row justify-center items-center gap-6 px-4 sm:px-10 md:px-16">
          <div
            className="h-48 sm:h-64 md:h-[300px] w-full sm:w-[450px] bg-amber-200 rounded-2xl bg-cover bg-center border-4 border-gray-300"
            style={{ backgroundImage: `url('/images/trust.jpg')` }}
          ></div>

          <div className="grid grid-cols-1 gap-6">
            <div
              className="h-40 sm:h-52 md:h-[250px] w-full sm:w-[280px] bg-cover bg-center rounded-2xl border-4 border-gray-200"
              style={{ backgroundImage: `url('/images/deliveryone.jpg')` }}
            ></div>

            <div className="bg-gray-300 h-32 sm:h-44 md:h-[180px] w-full sm:w-[280px] flex justify-center items-center rounded-2xl px-2 border-4 border-gray-200">
